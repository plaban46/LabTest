...
public class CityList {
    ...
    public static void main(String[] args) {
        City c1=new City("Dumuria","Khulna");
        City c2=new City("Gopalgang"," Dhaka");
        City c3=new City("Tala","Sathkhira");
        City c4=new City("Paikgacha","Khulna");
        City c5=new City("Kamlapur","Dhaka");
